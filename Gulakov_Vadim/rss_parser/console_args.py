...
parser.add_argument('source',
                    ...
                    type=str,
                    help='RSS URL')
parser.add_argument('--version', nargs='?', default='2', const='2', type=str, help='Print version info')
parser.add_argument("--to-html", type=str, help="Convert rss feed into html and save as file")
parser.add_argument("--to-pdf", type=str, help="Convert rss feed into pdf and save as file")
